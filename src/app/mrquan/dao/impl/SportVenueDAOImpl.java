...
public class SportVenueDAOImpl implements ISportVenueDAO {
    ...
    @Override
    public SportVenue findSportVenuesBySerialNumber(String id) throws SQLException {
        SportVenue pojo = null;
        try {
            preparedStatement = con.prepareStatement("select * from sportVenues where serialNumber = ?");
